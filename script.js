window.onload = function () {
	...
	// установка коллбэк-функций на кнопки циферблата по событию нажатия
	...
	// установка коллбэк-функций для кнопок операций
	...
	changeThemeButton.onclick = function () {
		styleDark = document.querySelector('link[href="style_dark.css"]')
		styleLight = document.querySelector('link[href="style_light.css"]')
